...
export const Input = (props: InputFormProps) => {
  ...
  <div className="relative">
    ...
    <input onChange={props.onChange} name={props.name} value={props.value} ref={props.reference} type={props.type || "text"} id={`${props.placeholder}`} className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-1000 focus:border-purple-1000 block w-full ps-10 p-2 dark:bg-black dark:text-white" placeholder={props.placeholder} />
  </div>
</div>
    )
}