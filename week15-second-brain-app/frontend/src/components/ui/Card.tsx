...
const hoverStyles = "hover:cursor-pointer hover:scale-[1.02] duration-300"
...
export const Card = (props: CardProps) => {
    ...
    return <div>
        <div className={`${sizeStyles[props.size]} ${defaultStyles} ${hoverStyles}`} onMouseOver={() => {setHover(true)}} onMouseLeave={() => setHover(false)}>
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                    <div className={`pr-2 text-gray-500 hover:text-gray-800 ${hoverStyles}`}>
                        <TrashIcon size="md" />
                    </div>
                </div>
            </div>
