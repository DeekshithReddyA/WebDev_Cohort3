...
//                 className={cn(
//                   "relative overflow-hidden z-40 bg-white dark:bg-neutral-900 flex flex-col items-start justify-start md:h-18 p-2 mt-2 w-full mx-auto rounded-md",
//                   "shadow-sm"
//                 )}
//               >
...
//                   animate={{ opacity: 1 }}
//                   layout
//                   className="text-sm mt-2 px-1 py-0.5 rounded-md bg-gray-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400"
//                 >
//                   {file.type}
//                 </motion.p>
//               </motion.div>
